...
class FixedDepositController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect('fixed-depisit')->with('success','Deposit added successfully');
    ...
    public function update(Request $request)
    {
        ...
        return redirect('fixed-depisit')->with('success','Deposit updated successfully');
    ...
    public function delete(Request $request)
    {
        ...
        return redirect('fixed-depisit')->with('success','Deposit Deleted successfully');
    }
